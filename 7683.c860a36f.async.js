"use strict";(self.webpackChunkblog_cq=self.webpackChunkblog_cq||[]).push([[7683],{77683:function(d,a,e){e.r(a),e.d(a,{texts:function(){return n}});const n=[{value:"Next.js \u53EF\u4EE5\u901A\u8FC7\u6839\u76EE\u5F55\u7684 ",paraId:0,tocIndex:0},{value:"next.config.js",paraId:0,tocIndex:0},{value:" \u8FDB\u884C\u914D\u7F6E\uFF1A",paraId:0,tocIndex:0},{value:`/** @type {import('next').NextConfig} */
const nextConfig = {
  /* config options here */
};
